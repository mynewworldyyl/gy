...
public class SmsInterfaceServiceLocator extends org.apache.axis.client.Service implements SmsInterfaceService {
    ...
    public SmsInterface_PortType getSmsInterface(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SmsInterfaceSoapBindingStub _stub = new SmsInterfaceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SmsInterface_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                SmsInterfaceSoapBindingStub _stub = new SmsInterfaceSoapBindingStub(new java.net.URL(SmsInterface_address), this);
                _stub.setPortName(getSmsInterfaceWSDDServiceName());
                return _stub;
            }
        }

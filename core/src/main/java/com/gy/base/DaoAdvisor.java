...
public class DaoAdvisor {
     ...
     * 该方法就是一个标识，不进行调用 
     */                    
    @Pointcut("execution(* com.gy.base.BaseJpalDao.save*(..))  ")  
    private void aspectjSaveMethod(){};
    
    @Pointcut("execution(* com.gy.base.BaseJpalDao.merge*(..)) "
    		+ " || execution(* com.gy.base.BaseJpalDao.update*(..)) "
    		)  
